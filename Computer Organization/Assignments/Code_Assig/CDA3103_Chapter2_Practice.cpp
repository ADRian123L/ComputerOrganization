/*
  Use this tool for data representation practice
   1. convert unsigned decimal numbers to binary numbers
   2. convert unsigned binary numbers to decimal numbers
   3. convert unsigned decimal numbers to octal numbers
   4. convert unsigned octal numbers to decimal numbers
   5. convert unsigned decimal numbers to hexadecimal numbers
   6. convert unsigned hexadecimal numbers to decimal numbers
   7. convert signed decimal numbers to sign-magnitude binary numbers
   8. convert signed decimal numbers to 1's complementary binary numbers
   9. convert signed decimal numbers to 2's complementary binary numbers
   10. convert sign-magnitude binary numbers to decimal numbers
   11. convert 1's complementary binary numbers to decimal numbers
   12. convert 2's complementary binary numbers to decimal numbers
   13. 1's complement arithmetic operation
   14. 2's complement arithmetic operation
*/

// Explain the program to the user.
// Prompt the user to enter his/her name.
// Prompt the user to select a practice item.
// Generate a random number.
// Convert the random number to the selected format.
// Prompt the user to enter the converted number.
...
int main()
{
	...
	std::cout << "Welcome to CDA 3103 Computer Organization Chapter 2 Data Representation Practice" << endl << endl;
	...
	while (tolower(choice) == 'y')
	{
		if (tolower(choice) == 'y')
			...
			<< "2. convert unsigned binary numbers to decimal numbers" << endl
			<< "3. convert unsigned decimal numbers to octal numbers" << endl
			<< "4. convert unsigned octal numbers to decimal numbers" << endl
			<< "5. convert unsigned decimal numbers to hexdecimal numbers" << endl
			<< "6. convert unsigned hexdecimal numbers to decimal numbers" << endl
			<< "7. convert signed decimal numbers to sign - magnitude binary numbers" << endl
			<< "8. convert signed decimal numbers to 1's complementary binary numbers" << endl
			<< "9. convert signed decimal numbers to 2's complementary binary numbers" << endl
			<< "10. convert sign - magnitude binary numbers to decimal numbers" << endl
			<< "11. convert 1's complementary binary numbers to decimal numbers" << endl
			<< "12. Convert 2's complementary binary numbers to decimal numbers" << endl
			<< "13. 1's complement arithmetic operation" << endl
			<< "14. 2's complement arithmetic operation" << endl << endl;
		...
		int menu_item = 0;
		while (menu_item < 1 || menu_item > 14)
		{
			cout << "\nPlease select the practice item: ";
			cin >> menu_item;
			if (cin.good())
			{
				if (menu_item < 1 || menu_item > 14)
					cout << "Menu item must be within [1-14], please try again!" << endl;
				else
					break;
			}
			else if (cin.fail())
